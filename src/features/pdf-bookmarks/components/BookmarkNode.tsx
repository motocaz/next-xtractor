...
export const BookmarkNode = ({
  ...
  const highlight =
    isMatch && searchQuery ? "bg-yellow-100 dark:bg-yellow-900/30" : "";
  ...
  const customColorStyle = node.color?.startsWith("#")
    ? { color: node.color }
    : undefined;
    ...
    >
      ...
      >
        ...
        <button
          ...
          aria-label={`Navigate to ${node.title} on page ${node.page}`}
        >
          <span
