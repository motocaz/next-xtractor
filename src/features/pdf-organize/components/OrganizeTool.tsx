...
export const OrganizeTool = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-8">
      ...
      <h2 className="text-2xl font-bold text-foreground mb-4">Organize PDF</h2>
      <p className="mb-6 text-muted-foreground">
        Reorder or delete pages with a simple drag-and-drop interface. Drag pages to reorder them,
        or use the delete button to remove pages.
      </p>
